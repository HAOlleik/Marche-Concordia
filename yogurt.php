                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/yogurt.jpg" alt = "yogurt image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Original Yogurt</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p>Naturally thick and refreshingly creamy.100% natural ingredients. 
                      No gelatin.No preservatives.Source of calcium.No added sugar.</p>
                  </div>
