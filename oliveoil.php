                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="grocery/olive oil.jpg" alt = "olive oil image" width="300"> </a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                      ...
                      <div class="line_text">
                  <p> Extra Virgin Olive oil. Ideal for every cooking.
                      It arouses pleasant reactions to the nose and mouth with its dominant green almond aroma.</p>
                  </div>
