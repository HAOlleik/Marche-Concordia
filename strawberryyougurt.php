                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/strawberry yogurt.jpg" alt = "syogurt image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Strawberry Yogurt</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Rich in flavor, creamy in texture, and packed with billions of live and active probiotics. 
                      Delicious and creamy, it's the perfect snack any time of day.</p>
                  </div>
