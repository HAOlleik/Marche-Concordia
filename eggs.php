...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Eggs-18 Extra Large Eggs</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/eggs.jpg" alt = "eggs image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Eggs-18 Extra Large Eggss</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Eggs are regarded as a 'complete' source of protein as they 
                      contain all nine essential amino acids, which we must obtain from our diet.</p>
                  </div>
