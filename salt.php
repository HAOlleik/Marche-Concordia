                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">     <img src="grocery/salt.png" alt = "salt image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Household salt</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Windsor table salt is a product of Canada. Great for cooking and baking.This well-known Windsor® product is one
                       of the reasons the Windsor brand is so trusted. Offering a consistent quality that you can rely on.</p>
                  </div>
