                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/Nateral.jpg" alt = "nateral image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Homogenized Milk</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p>Nateral Organic Fine-Filtered Milk comes from Canadian dairy farms dedicated to 
                      organic farming principles. Vitamin D added.</p>
                  </div>
