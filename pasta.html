...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Penne Rigate Pasta</title>
                    ...
                    <li>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                              ...
                              <a href="catefory3_final.html">Dairy Products</a>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">    <img src="grocery/pasta.jpeg" alt = "pasta image" width="300"> </a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Penne Rigate Pasta</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> One of the most famous Italian pasta shapes and loved.Made with 100% durum wheat and water to deliver great taste.</p>
                  </div>
