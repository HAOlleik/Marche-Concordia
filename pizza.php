                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="frozen/Pizza.jpg" alt = "pizza image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                      ...
                      <div class="line_text">
                  <p> Ristorante pizza Hawaii.Thin and crispy piiza with chicken breast, pineapple and cheese. Easy to bake.</p>
                  </div>
