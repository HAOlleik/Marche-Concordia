...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Organic Whole Milk 3.8%</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/organic-milk.png" alt = "org milk image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Organic Whole Milk 3.8%</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Organic Year Round Grass Fed Milk Is Now Available! Our new organic grass fed milk 
                      comes from cows that eat organic grass and dried forages year-round. When cows are fed
                       the diet they evolved to eat, the end result is healthier farms, healthier animals and healthier dairy products.</p>
                  </div>
