                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="frozen/fish sticks.jpeg" alt = "fstickimage" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                      ...
                      <div class="line_text">
                  <p> Perfectly crispy and exceptionally dippable, Gorton's Crunchy Breaded Fish Sticks are always
                       delicious and made from 100% wild-caught, responsibly sourced fish, making them the perfect intro for
                        seafood-reluctant family members.Excellent source of protein; Natural omega-3 No artificial colors, flavors 
                        or preservatives.</p>
                  </div>
