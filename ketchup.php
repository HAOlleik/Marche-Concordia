...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Heinz Tomato Ketchup</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">    <img src="grocery/ketchup.jpg" alt = "ketchup image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                      ...
                      <div class="line_text">
                  <p> Heinz Tomato Ketchup with no sugar added.Made with fresh red, ripe and juicy Heinz tomatoes.</p>
                  </div>
