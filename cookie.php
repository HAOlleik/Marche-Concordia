...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Chips Ahoy Original</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="grocery/cookie.jpg" alt = "cookie image" width="300"></a>  </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Chips Ahoy Original</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Canada's #1 Chocolate Chip Cookie Brand - CHIPS AHOY!.
                       They’re crammed with real chocolate chips.So Crunchy, So Delicious.</p>
                  </div>
