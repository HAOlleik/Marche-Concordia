            ...
            <div class="col-md-6">
                <div class="d-flex flex-column justify-content-center">
                    <div class="product_image">
                        <a href="#"> <img src="frozen/icecream sandwiches.jpg" alt="isandwich image" width="300"></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class=" right-side">
                    ...
                    <div class="line_text">
                        <p> Scotsburn IceCream sanwiches are Vanilla ice cream sandwiched between two chocolatey wafers.
                        </p>
                    </div>
