                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">   <img src="img_veg_fruits/tomato.png" alt = "tomatao image" width="300"> </a></div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        ...
                        <div class = "product-price">
                            <p>1 fruit (approx. 150 g)</p> 
                            <p> approx. $1.15 / unit</p>
                         </div>
                        

                         <button class = "button0" onclick="myFunction()"> More Description</button>
                      <div class="line_text">
                  <p> Tomato fruit can be eaten raw or cooked and is used in many dishes. The fruit may also be processed into juice, soup, 
                      ketchup, puree, paste or powder.They are also a great source of vitamin C, potassium, folate, and vitamin K.</p>
                  </div>
