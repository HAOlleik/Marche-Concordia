...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Real Premium Icecream</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="frozen/iceCream.jpg" alt = "icecream image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Real Premium Icecream</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Prestige Real Premium Ice Cream Creamy Chocolate.Indulgent chocolate ice cream.
                       No artificial colors and flavors.</p>
                  </div>
