...
<<<<<<< HEAD
                <a href="/index.php"><img src="images/logo.jpg" class="nav-logo-img" alt="Store Logo" height="120"
                        width="120"></a>
=======
                <a href="index.php"><img src="images/logo.jpg" class="nav-logo-img" alt="Store Logo" height="120" width="120"></a>
>>>>>>> d1ffb20b4e4d0667a63c70c7eb049d7ae3ddfa76
            </div>
            <br><br>
...
<<<<<<< HEAD
                    ...
                    <li><a href="/yourCart.php" class="cart"><img src="images/cart.png" class="cart-img" height="55"
                                width="55"></a>
=======
                    <li><a href="https://www.google.com/maps/place/Pavillion+Henry+F.Hall+Bldg,+Boulevard+de+Maisonneuve+O,+Montreal,+QC+H3G+1M8/@45.4973223,-73.5812175,17z/data=!3m1!4b1!4m5!3m4!1s0x4cc91a6a8799deb5:0x1ca01f129dc2ef02!8m2!3d45.4973223!4d-73.5790288" class="location"><img src="images/location.jpg" class="location-img" height="55" width="55"></a></li>
                    <li><a href="/signIn.php" class="sign-in"><img src="images/sign-in.png" class="sign-in-img" height="55" width="55"></a></a></li>
                    <li><a href="/yourCart.php" class="cart"><img src="images/cart.png" class="cart-img" height="55" width="55"></a>
>>>>>>> d1ffb20b4e4d0667a63c70c7eb049d7ae3ddfa76
                    </li>
    ...
    <section class="outer_edit1">
        <form id="inner_edit1" action="text.php" method="post">
            <h1>Sign in</h1>
            <hr>
            <input id="input" type="text" size="30" name="username" placeholder="Email">
            <input id="input" type="password" size="30" name="password" placeholder="Password">
            <p id="forgot"><?php print $_SESSION['error']; session_destroy(); ?></p>
            <div>
<<<<<<< HEAD
...
=======
                <input type="submit" id="save" name="submit" value="Submit">
            </div>
        </form>
    </section>
    <div>
...
>>>>>>> d1ffb20b4e4d0667a63c70c7eb049d7ae3ddfa76
    ...
    <footer class="footer-class">
        <div class="container-footer">
            ...
            <a data-toggle="collapse" role="button" aria-expanded="false" aria-controls="Contact" href="#Contact">Contact Us</a>
