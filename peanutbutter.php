                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">      <img src="grocery/peanut butter.jpg" alt = "peanutbutter image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                      ...
                      <div class="line_text">
                  <p> Kraft peanut butter is a Canadian classic that brings deliciousness to the table, 
                      and to the families and friends around it.Made with quality dry-roasted peanuts to bring out the best flavour.</p>
                  </div>
