                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="frozen/fries.jpeg" alt = "fries image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        ...
                        <div>
                            <p class = "deal-color">$1.99</p>
                        </div>
                        

                        <button class = "button0" onclick="myFunction()"> More Description</button>
                      <div class="line_text">
                  <p> A classic choice, they deliver crispy goodness in every bite.
                       McCain fries are made with specially selected potatoes. Trans-fat free, cholesterol free and easy to prepare.</p>
                  </div>
