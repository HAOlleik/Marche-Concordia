...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Semi Salted Butter</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/butter.jpg" alt = "butter image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Semi Salted Butter</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Lactantia® butter is traditionally made with churned 100% pure pasteurized cream. 
                      Canada’s number one brand of butter is available in many varieties to suit your taste and
                       lifestyle.Made with 100% pure cream. All natural. No preservatives.</p>
                  </div>
