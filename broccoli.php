                    ...
                    <li>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                              ...
                              <a href="category4_g=final.html">Grocery</a>
                            </div>
                          </div>
                    </li>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="img_veg_fruits/broccoli.png" alt = "broccoli image" width="300"> </a></div>
                ...
                <div class="col-md-6">
                    <div class=" right-side">
                        ...
                        <div class = "product-price">
                            <p> Crowns 1lb</p> 
                            <p> approx. $1.79 / unit</p>
                         </div>
                        

                         <button class = "button0" onclick="myFunction()"> More Description</button>
                      <div class="line_text">
                  <p> This green veggie can be enjoyed both raw and cooked Broccoli is high in many nutrients,
                       including fiber, vitamin C, vitamin K, iron, and potassium. It also boasts more protein.</p>
                  </div>
