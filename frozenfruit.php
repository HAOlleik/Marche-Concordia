                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="frozen/frozen-fruit.jpg" alt = "ffruit image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Field Berry Mix</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p> Europe's best brand Field Berry mix contains strawberries, blueberries and blackberries.
                       All natural fruit. No sugar added.Good source of Vitamin C.</p>
                  </div>
