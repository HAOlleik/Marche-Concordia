            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <a href="#">   <div class="product_image"> <img src="img_veg_fruits/grapes.png" alt = "grapes image" width="300"></a> </div>
                ...
                <div class="col-md-6">
                    <div class=" right-side">
                        ...
                        <div class = "product-price">
                            <p> 1 bag (approx. 460 g)</p> 
                            <p> approx. $3.54 / unit</p>
                         </div>
                        

                         <button class = "button0" onclick="myFunction()"> More Description</button>
                      <div class="line_text">
                  <p> Grapes are versatile fruits used in a wide range of popular foods.
                       Grapes are also a good source of vitamin K, copper and many of the B vitamins.</p>
                  </div>
