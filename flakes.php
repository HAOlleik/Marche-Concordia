...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Cranberry Almond Crunch</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="grocery/flakes.jpg" alt = "flakes image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Cranberry Almond Crunch</h2>
                        </div>
                      ...
                      <div class="line_text">
                  <p>These Cranberry Almon Crunch contains cranberries, multigrin flakes, 
                      cluster and almonds that makes this cereal taste so delicious. Source of
                       fibre and no artificial flavour.</p>
                  </div>
