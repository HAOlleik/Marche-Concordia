      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              class="d-block w-100"
              src="images/comptoir.jpg"
              alt="First slide"
            />
            <div class="carousel-caption d-none d-md-block">
              <h5 id="carousCaption1">Good Prices</h5>
              <p id="carousCaption1">Our prices are uncomparable!!</p>
            </div>
          </div>
          <div class="carousel-item">
            ...
            />
            <div class="carousel-caption d-none d-md-block">
              <h5 id="carousCaption1">Variety</h5>
              <p id="carousCaption1">
                Come check the variety of vegis and fruits we have to create
                your own salads.
              </p>
            </div>
          </div>
          <div class="carousel-item">
            <img
              class="d-block w-100"
              src="images/rawshe_editted1.jpg"
              alt="Second slide"
            />
            <div class="carousel-caption d-none d-md-block">
              <h5 id="carousCaption">Food Origin</h5>
              <p id="carousCaption">
                All our fruits come from one of the best lands in the world,
                LEBANON!
              </p>
            </div>
          </div>
