...
<head>
    ...
    <!-- <script type="text/javascript" src="C:\Users\Anum\Desktop\page3\main.js"></script> -->
            ...
            <div class="col-md-6">
                <div class="d-flex flex-column justify-content-center">
                    <div class="product_image">
                        <a href="#"> <img src="img_veg_fruits/apples.png" alt="Apple image" width="300"></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class=" right-side">
                    ...
                    <div class="product-price">
                        <p> 1 fruit (approx. 180 g)</p>
                        <p> approx. $1.38 / unit</p>
                    </div>
                    ...
                    <div class="line_text">
                        <p> Meet the world’s favorite snacking apple. The heart-shaped Red
                            Delicious features a bright red and sometimes striped skin. Renowned
                            for its crunchy texture and mildly sweet flavor,this tasty apple shines
                            in cool, crisp salads.</p>
                    </div>
