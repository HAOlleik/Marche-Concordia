...
<head>
   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <title>Eggs-12 Large Organic Eggs</title>
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/organic-eggs.jpg" alt = "oeggs image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2>Eggs-12 Large Organic Eggs</h2>
                        </div>
                        ...
                        <div>
                            <p class = "deal-color">$4.50</p>
                        </div>
                        

                        <button class = "button0" onclick="myFunction()"> More Description</button>
                      <div class="line_text">
                  <p> All of Contestoga Farms organic laying hens are fed Canadian Organic Regime (COR) certified feed, 
                      made from non-GMO grains. These non-GMO grains are produced on prohibited substance-free land. 
                      Our organic feed is 100% vegetarian with no animal by-products.</p>
                  </div>
