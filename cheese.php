                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column justify-content-center">
                        <div class="product_image">
                            <a href="#">  <img src="dairy/cheese.jpg" alt = "cheese image" width="300"></a> </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class=" right-side">
                      ...
                      <div class="line_text">
                  <p> Broaden your taste buds with these crunchy cheddar cheese bites. Made with 100% cheddar, 
                      they’re rich, savory, and packed with protein to give you a delicious boost of energy whenever you need it..</p>
                  </div>
